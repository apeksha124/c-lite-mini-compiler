...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUM", "ID", "ASSIGN",
  "PLUS", "MINUS", "MUL", "DIV", "NEWLINE", "$accept", "program",
...
{
      14,     7,    15,    16,    17,    18,     2,     3,    13,     3,
       4,     9,    10,    11,    12,    11,    12,     0,     8
};

static const yytype_int8 yycheck[] =
{
       7,     5,     9,    10,    11,    12,     0,     3,     4,     3,
       4,     6,     7,     8,     9,     8,     9,    -1,    10
};
...
#line 39 "parser.y"
                           {
        content_t c = assign_symbol((yyvsp[-2].str), (yyvsp[0].cont)); free((yyvsp[-2].str));
        printf("Assigned %d\n", c.data_type);
        printf("Generated IR:\n%s%s = %s\n", (yyvsp[0].cont).code ? (yyvsp[0].cont).code : "", c.entry->lexeme, (yyvsp[0].cont).addr);
    }
#line 1090 "parser.tab.c"
    break;

  case 6: /* expression: NUM  */
#line 49 "parser.y"
                              { (yyval.cont) = create_num_content((yyvsp[0].ival)); }
#line 1096 "parser.tab.c"
    break;

  case 7: /* expression: ID  */
#line 50 "parser.y"
                              { (yyval.cont) = lookup_or_create_symbol((yyvsp[0].str)); free((yyvsp[0].str)); }
#line 1102 "parser.tab.c"
    break;

  case 8: /* expression: expression PLUS expression  */
#line 51 "parser.y"
                                   { (yyval.cont) = create_binop('+', (yyvsp[-2].cont), (yyvsp[0].cont)); }
